...
// call this to initize the autocomplete logic between an input field ( inputTextJQSelector), a div when google will put the map (canvasId) and two field where the lat and long are  recorded
function initializeGeoCoder(inputTextJQSelector, canvasId, locationLatJQSelector, locationLongJQSelector, initLat, initLong) {
